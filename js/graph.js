  ...
  { 
    ...
    tariffs: {
      ...
      premium: {
        price: '55 000 ₽',
        name: 'Gold',
        description: 'Удалённая подача без присутствия при наличии биометрии за 5 лет. Все сборы включены.',
        features: ['Удалённо', 'Всё включено', 'Доставка']
      },
      vip: {
        price: '85 000 ₽',
        name: 'Premium',
        description: 'Виза за 30 дней.',
        features: ['30 дней', 'Приоритет']
      }
    }
  },
  { 
    ...
    tariffs: {
      ...
      premium: {
        price: '55 000 ₽',
        name: 'Premium',
        description: 'Удалённая подача по доверенности. Все сборы включены.',
        features: ['Удалённо', 'Всё включено', 'Доставка']
      }
    }
  },
