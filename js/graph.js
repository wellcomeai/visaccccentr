...
const nodesData = [
  ...
  { 
    ...
    tariffs: {
      ...
      premium: {
        price: '55 000 ₽',
        name: 'Gold',
        description: 'Удалённая подача без вашего присутствия при наличии биометрии за 5 лет. Сборы оплачиваются отдельно.',
  ...
  { 
    ...
    tariffs: {
      gold: {
        price: '27 000 ₽',
        name: 'Стандарт',
        description: 'Туристическая или бизнес-виза. Оформление документов и запись в визовый центр.',
        features: ['Упрощённый пакет', 'Помощь с приглашением', 'Сборы отдельно']
      },
      premium: {
        price: '55 000 ₽',
        name: 'Premium',
        description: 'Удалённая подача по доверенности. Упрощенный пакет документов. Сборы оплачиваются отдельно.Запись в визовый центр.',
        features: ['Удалённо', 'Всё включено']
      }
    }
  },
  ...
  { 
    ...
    x: 38, 
    y: 15, 
    description: 'Самое быстрое оформление. Необходимы выкупленные билеты', 
    price: '15 000 ₽', 
    icon: '🇬🇷', 
    flag: 'GR', 
